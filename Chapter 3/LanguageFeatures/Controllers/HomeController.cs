...
namespace LanguageFeatures.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult CreateProduct()
        {
            ...
            myProduct.Name = "Kayak";
            myProduct.Description = "A bot for one person";
            myProduct.Price = 275M;
            myProduct.Category = "Watersport";
        ...
        {
            //crate and populate ShoppingCart obj
        ...
        public ViewResult UseFilterExtensionMethod()
        {
            IEnumerable<Product> products = new ShoppingCart 
            {
                Products = new List<Product>
                {
                    ...
                    new Product {Name ="Corner flas", Category = "Soccer", Price = 34.95M},
                }
            };
        ...
        public ViewResult UseFilterExtensionMethod2()
        {
            ...
            //first way to create a delegate for filter extension method
            Func<Product, bool> categoryFilter = delegate(Product prod) {
                return prod.Category == "Soccer";            
            };

            //second way to crate a delegate for filter extension method --> using LMBDA expression
            Func<Product, bool> categoryFilter2 = prod => prod.Category == "Soccer";

            //call filter extension method create a func variable
            foreach (Product prod in products.Filter(categoryFilter))
            {
                total += prod.Price;
            }

            //call filter extension method without create a fucn variable
            foreach (Product prod in products.Filter(prod => prod.Category == "Soccer"))
            {
                total += prod.Price;
            }

            //filter IEnumerable with more than one condition
        ...
        public ActionResult FindProductsWithLinq()
        {
            Product[] products = {
        ...
        public ActionResult FindProductsWithLinqDotNotification()
        {
            Product[] products = {
                new Product {Name = "Kayak", Category = "Watersports", Price = 275M},
                new Product {Name = "Lifejacket", Category = "Watersports", Price = 48.95M},
